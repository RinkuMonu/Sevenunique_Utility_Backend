...
exports.bankFetch = async (req, res) => {
  try {
    ...
    const aeronpayRes = await axios.post(
      "https://api.aeronpay.in/api/serviceapi-prod/api/payout/bankid_list",
      {
        category: "bankids",
      },
...
exports.callBack = async (req, res) => {
  ...
  try {
    logApiCall({
      url: "https://api.sevenunique.com/aeronpay/transfer/callbackData",
      requestData: {},
